    ...
    <div>
        ...
        <el-card class="box-card">
            ...
            <el-row :gutter="20">
                ...
                <el-col :span="4">
                    <el-button type="primary" @click="openAddForm">添加课程</el-button>
                </el-col>
            </el-row>
        ...
        <!-- 添加计划的对话框 -->
        <arr-form
            :addArrDialogVisible="addArrDialogVisible"
            :arrForm="arrForm"
            :expOptions="expOptions"
            @close="closeEdit"
        ></arr-form>
...
<script>
    ...
    import lessonEdit from "./lesEdit.vue"
    import arrAdd from "../Arrangement/arrAdd.vue"
    ...
    export default {
        ...
        methods:{
            ...
            async getLesList(){
                ...
                const {data:res} =await this.$http.get('les/leslist',{params: this.queryInfo})
                // console.log(res)
                if (res.status !== 0) {
            ...
            async openArrAdd(id){
                ...
                this.arrForm.chapter = 1
                this.addArrDialogVisible = true
            },
            // 搜索课程
            async lesSelect(){
